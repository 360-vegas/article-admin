...
watch($storage, ({ layout }) => {
  switch (layout["layout"]) {
    case "vertical":
      ...
      debounce(setFalse([dualColumnRef]), 50);
      break;
    case "horizontal":
    ...
    case "mix":
      ...
      break;
    case "dual-column":
      toggleClass(true, "is-select", unref(dualColumnRef));
      debounce(setFalse([verticalRef]), 50);
      debounce(setFalse([horizontalRef]), 50);
      debounce(setFalse([mixRef]), 50);
      break;
    ...
    <div class="p-5">
      ...
      <ul class="pure-theme">
        ...
        <li
          ...
          ref="dualColumnRef"
          v-tippy="{
            content: t('panel.pureDualColumnTip'),
            zIndex: 41000
          }"
          :class="layoutTheme.layout === 'dual-column' ? 'is-select' : ''"
          @click="setLayoutModel('dual-column')"
        >
          <div />
          <div />
        </li>
